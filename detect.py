...
if __name__ == "__main__":
    ...
    model_add = '/home/iclab/Desktop/kid_hurocup/src/strategy/us/82/best-int8_edgetpu.tflite'
    conf_thresh = 0.7                                                                           #信心閥值
    iou_thresh = 0.002                                                                        #真實框與檢測框重疊度
    yaml_add = '/home/iclab/Desktop/kid_hurocup/src/strategy/us/targetdata320.yaml'
    quiet = False
    ...
    while not rospy.is_shutdown():    
        try:
            image = ros_image.originimg.copy()
